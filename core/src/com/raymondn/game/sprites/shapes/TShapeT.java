 ...
 */
public class TShapeT extends TShape{
    ...
    private final String TAG = "Class: TShapeT";
    
    public TShapeT(PlayState ps) {
        super(ps);
        tileWidth = 3;
        tileHeight = 3;
    ...
    protected void positionSprites() {
        ...
        spritePositions[0] = new Vector2(getStartingPosition());
        ...
        spritePositions[3] = new Vector2(spritePositions[2].x,
                spritePositions[2].y
                - oneUnit);
        spritePositions[4] = new Vector2(spritePositions[1].x
                + oneUnit,
                getStartingPosition().y);
    ...
    public void increment(int pos) {
        ...
        spritePositions[1].x = spritePositions[0].x + oneUnit;
        spritePositions[2].x = spritePositions[1].x;
        spritePositions[3].x = spritePositions[2].x;
        spritePositions[4].x = spritePositions[1].x + oneUnit;
    }
